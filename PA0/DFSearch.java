...
//			for(i = 0; i < removedTop.children.size(); i++) {
//				if(b == false || (frontier.contains(removedTop.children.get(i)) == false && exploredNode.contains(removedTop.children.get(i).loc.name) == false)) {
//					frontier.addToBottom(removedTop.children.get(i));
//				}
//			}
